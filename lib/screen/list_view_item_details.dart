...
class ListItemDetails extends StatelessWidget {
  ...
  const ListItemDetails(this.item, {Key? key}) : super(key: key);
...
class SetTagsItem extends StatelessWidget {
  ...
  const SetTagsItem({Key? key, this.tag}) : super(key: key);
...
class HeaderBanner extends StatelessWidget {
  ...
  const HeaderBanner({Key? key, this.item}) : super(key: key);
    ...
    return Material(
      ...
      child: SizedBox(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: <Widget>[
            HeaderImage(bannerUrl: item!.bannerUrl),
            HeaderContent(item!),
          ],
        ),
      ),
...
class HeaderImage extends StatelessWidget {
  ...
  const HeaderImage({Key? key, this.bannerUrl}) : super(key: key);
